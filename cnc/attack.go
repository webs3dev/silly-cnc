...
func NewAttack(str string, admin int) (*Attack, error) {
    ...
    if len(args) == 0 {
        ...
        if args[0] == "?" {
            validCmdList := "\033[0;35m Hemi Attack Methods\r\n\033[1;37m"
        ...
        if !exists {
            return nil, errors.New(fmt.Sprintf("\033[0;31m%s \033[1;35mTHIS IS DUMB AND IS NOT A \033[0;35mHEMI Command\033[0;31m!", args[0]))
        }
